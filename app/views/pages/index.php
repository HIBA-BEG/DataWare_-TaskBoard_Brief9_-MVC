...
<body>
    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-notwhite-color">
            <form action="<?php echo URLROOT ; ?>/users/login" method="post" class="bg-notwhite-color">
                ...
                <button type="submit" value="Login" class="block w-full bg-gradient-to-tr from-orange-color to-darkred-color mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
                <a href="<?php echo URLROOT ;?>/users/register" class="text-sm ml-2 hover:text-blue-500 cursor-pointer">You don't have an account? Click here to create one...</a>
            </form>
        </div>
    </div>
    </section>
        ...
        <a href="#" class="flex-shrink-0 w-full group block">
          <div class="flex items-center">
            ...
            <div class="ml-3">
              ...
              <p class="text-xs font-medium text-notwhite-color group-hover:text-gray-800">View profile</p>
            </div>
          </div>
        </a>
      </div>
  ...
  <div class="md:pl-64 flex flex-col flex-1">
    <div class="sticky mt-6 z-10 flex h-16">
      ...
      <div class="px-4 flex">
        ...
        <button type="button" class="flex shadow rounded-lg px-4 border-r border-gray-200 text-darkred-color focus:outline-none focus:ring-2 focus:ring-inset focus:ring-darkred-color">
    ...
    <main class="flex-1">
      <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 class="text-2xl font-semibold text-orange-color">Dashboard</h1>
        </div>
          ...
          <div class="py-4">
            ...
            <div class="flex items-center justify-center">
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                ...
                <!-- To Do -->
                <div>
                  <p class="mb-12 text-xl font-semibold my-2"> + To Do </p>
                  <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    ...
                    <div class="mt-8">
                      <p class="text-xl font-semibold my-2">Project: </p>
                ...
                <!-- Doing -->
                <div>
                  <p class="mb-12 text-xl font-semibold my-2"> + Doing </p>
                  <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                      ...
                      <div class="flex justify-between">
                        <div class="my-2">
                          ...
                          <div class="flex space-x-2">
                            <img src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="w-6 h-6 rounded-full" />
                          </div>
                        </div>
                        <div class="my-2">
                ...
                <!-- Done -->
                <div>
                  <p class="mb-12 text-xl font-semibold my-2"> + Done </p>
                  <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
                    ...
                    <div class="mt-8">
                      ...
                      <div class="flex justify-between">
                        <div class="my-2">
                          ...
                          <div class="flex space-x-2">
                            <img src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" class="w-6 h-6 rounded-full" />
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxSqK0tVELGWDYAiUY1oRrfnGJCKSKv95OGUtm9eKG9HQLn769YDujQi1QFat32xl-BiY&usqp=CAU" class="w-6 h-6 rounded-full" />
                            <img src="https://upload.wikimedia.org/wikipedia/commons/e/ec/Woman_7.jpg" class="w-6 h-6 rounded-full" />
                          </div>
                        </div>
                        <div class="my-2">
                          <p class="font-semibold text-base mb-2">Progress</p>
