...
<body class="flex flex-col flex-1 bg-notwhite-color">
  ...
  <div class="md:pl-64 flex flex-col flex-1">
    <div class="sticky mt-6 z-10 flex h-16">
      ...
      <div class="px-4 flex">
        <button type="button" class="flex shadow px-4 border-r rounded-lg border-gray-200 text-darkred-color focus:outline-none focus:ring-2 focus:ring-inset focus:ring-darkred-color ">
          <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
            <path fill="#b20000" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" />
          </svg>
          Add Task
        </button>
